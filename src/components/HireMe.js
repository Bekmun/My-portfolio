...
const HireMe = () => {
	return (
		<div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto xs:right-4'>
			<div className='relative w-48 h-auto flex items-center justify-center md:w-24'>
				<CircularText className='fill-dark animate-spin-slow dark:fill-light' />
				<Link href='https://t.me/bekmun_gem' target='_blank' className='flex justify-center items-center absolute
				...
				md:w-12 md:h-12 md:text-[10px]'>Нанять</Link>
			</div>
		</div>
	)
}
